...
public class VentanaAdminstradorDeDiseno extends JFrame {

	public VentanaAdminstradorDeDiseno(boolean sinLayout, String title) {
		setSize(500, 500);
		setTitle(title);
		...
		if (sinLayout) {
			// setLocationRelativeTo(null); // ◰ (just positioning, no code related)
	...
	public void iniciarCompSinLayout() {
		...
		panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK),
				"Botones (JPanel) con setLayout(null)"));
...
// ****************************************************
	...
	public void iniciarCompConDefaultLayout() {
		...
		JPanel panel = new JPanel();
		panel.setBounds(10, 10, 400, 300); // ⇐ ventanaAdminDiseno.setLayout(null);
		panel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK),
				"Botones (JPanel) SIN setLayout"));
